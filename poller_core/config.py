...
P2_BURST_INTERVAL_S      = float(os.getenv("P2_BURST_INTERVAL_S",      "0.8"))  # burst-phase interval (aggressive)
...
LOG_POLL_SUCCESS_RESPONSES = os.getenv("LOG_POLL_SUCCESS_RESPONSES", "1") == "1"
POLL_SUCCESS_RESPONSE_LOG_LIMIT = int(os.getenv("POLL_SUCCESS_RESPONSE_LOG_LIMIT", "4000"))
